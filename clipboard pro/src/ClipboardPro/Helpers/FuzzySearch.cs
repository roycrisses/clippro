...
public static class FuzzySearch
{
    ...
    public static double GetSimilarityScore(string query, string target)
    {
        ...
        // Optimization: skip expensive Levenshtein for very large strings
    ...
    private static int LevenshteinDistance(string s1, string s2, bool isS1Lowered = false)
    {
        ...
        for (int j = 1; j <= n; j++)
        {
            ...
            // Efficiently swap rows using Spans
            var temp = prevRow;
            prevRow = currRow;
            currRow = temp;
        }
        ...
        double threshold = 0.3)
    {
        ...
        // Stable sort: primary DESC score, secondary ASC index (original order)
        // This is much more efficient than LINQ OrderByDescending
        results.Sort((a, b) =>
        {
